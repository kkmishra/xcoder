...
module Xcode
  module Builder
    ...
    class BaseBuilder
      ...
      attr_accessor :profile, :identity, :build_path, :keychain, :sdk, :objroot, :symroot, :destination
      ...
      def configuration_name_suffix
        @destination.nil? ? "iphoneos" : "iphonesimulator"
      end
